...
import com.example.appmvvm.databinding.ResItemLiveBinding
...
class MainViewHolder(private val binding: ResItemLiveBinding) : RecyclerView.ViewHolder(binding.root) {
